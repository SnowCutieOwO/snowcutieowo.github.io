...
* [⚠️ 兼容性](setup.compatibility.md)
* [📄 配置文件](setup.config.md)
* [⚙️ 问题排查](setup.faqs.troubleshooting.md)

## 功能
* [🖥️ 命令列表](features.commands.md)
* [🟩 Plan 联动](hooks.player-analytics.md)
* [🗺️ 地图联动](hooks.dynmap-bluemap-pl3xmap.md)
* [💵 经济联动](hooks.vault-economy.md)
* [⚠️ 严格 tpahere](features.commands.strict-tpahere.md)
* [🚫 地标限制](features.managing-access.restricted-warps.md)
* [⏰ 冷却](features.commands.command-cooldowns.md)
* [🌎 全局主城](features.global-spawn.md)
* [🛏️ 全局重生](features.global-spawn.global-respawning.md)
* [❓ 常见问题](setup.faqs.md)

## 教程
* [📊 导入数据](setup.setup.importing-data.md)
* [⛔ 访问控制](features.managing-access.md)
* [📜 冲突命令](features.commands.command-conflicts.md)
...
* [💻 GitHub](https://github.com/WiIIiam278/HuskHomes)
  * [📂 获取 HuskHomes](https://william278.net/project/huskhomes/)
