...
>   * [标志](usage.generation.md#标志)
>   * [变量](usage.generation.md#变量)
>   * [形状示例](usage.generation.md#形状示例)
...
> [!TIPS|label:提示]    
> 想要更多酷炫的形状吗？试试一个叫 [MathMod](https://github.com/parisolab/mathmod/releases) 的程序吧。它里面有很多形状，你也可以顺着它的教学创建更多。需要注意的是 WorldEdit 使用的是等角（x,y,z）方程，而不是参数（u,v,t）方程。另外，你也可能需要按选区比例和表达式定义域调整你的 x、y 和 z 变量。
