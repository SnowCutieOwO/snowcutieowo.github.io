...
>   * [二元中缀](usage.other.expression-syntax.md#二元中缀符)
>   * [前缀运算](usage.other.expression-syntax.md#前缀运算)
>   * [后缀运算](usage.other.expression-syntax.md#后缀运算)
>   * [三元中缀](usage.other.expression-syntax.md#三元中缀)
...
>   * [循环](usage.other.expression-syntax.md#循环)
...
**注意：**关键词 else 总是会和上一个 if 相关。这意味着你可以这样写多个条件判断式：
```
