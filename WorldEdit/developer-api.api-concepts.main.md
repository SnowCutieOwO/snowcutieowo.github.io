...
WorldEdit 使用了一些简单的概念来创建灵活的操作。这些概念会在下文叙述，且应该按顺序阅读，顺序靠后的概念有时候会参考前文的相关内容，如果不这么做的话有可能会造成理解困难。

* [操作方](developer-api.api-concepts.actors.md)
* [本地会话](developer-api.api-concepts.local-sessions.md)
  * [使用 LocalSession](developer-api.api-concepts.local-sessions.md#使用-localsession)
...
* [会话编辑](developer-api.api-concepts.edit-sessions.md)
  * [区段堆栈](developer-api.api-concepts.edit-sessions.md#区段堆栈)
  * [编辑会话事件](developer-api.api-concepts.edit-sessions.md#编辑会话事件)
