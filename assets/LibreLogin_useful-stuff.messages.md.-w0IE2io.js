import{_ as p,C as i,c as t,o as k,am as h,G as a}from"./chunks/framework.SAy2jMg1.js";const c=JSON.parse('{"title":"消息文本","description":"","frontmatter":{"breadcrumbs":[{"title":"Continue Project","link":"/LibreLogin"},{"title":"消息文本","link":"/LibreLogin/useful-stuff.messages"}]},"headers":[],"relativePath":"LibreLogin/useful-stuff.messages.md","filePath":"LibreLogin/useful-stuff.messages.md"}'),e={name:"LibreLogin/useful-stuff.messages.md"};function r(E,s,g,o,d,y){const n=i("NolebaseGitContributors"),l=i("NolebaseGitChangelog");return k(),t("div",null,[s[0]||(s[0]=h(`<h1 id="消息文本" tabindex="-1">消息文本 <a class="header-anchor" href="#消息文本" aria-label="Permalink to &quot;消息文本&quot;">​</a></h1><div class="language-toml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#  !!文件为 HOCON 格式!!</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">totp-wrong-version=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;客户端版本需高于 %low% - %high% 才可启用二步验证。之后才可再次使用旧版本登入。&quot;</span></span></code></pre></div>`,2)),a(n),a(l)])}const u=p(e,[["render",r]]);export{c as __pageData,u as default};
