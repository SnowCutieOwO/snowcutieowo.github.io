import{_ as a,c as i,a7 as n,o as l}from"./chunks/framework.CMhgUA9K.js";const d=JSON.parse('{"title":"动画","description":"","frontmatter":{},"headers":[],"relativePath":"DecentHolograms/general.configuration.animation.md","filePath":"DecentHolograms/general.configuration.animation.md"}'),t={name:"DecentHolograms/general.configuration.animation.md"};function e(p,s,h,k,r,c){return l(),i("div",null,s[0]||(s[0]=[n(`<h1 id="动画" tabindex="-1">动画 <a class="header-anchor" href="#动画" aria-label="Permalink to &quot;动画&quot;">​</a></h1><p>自定义动画的配置</p><h2 id="格式" tabindex="-1">格式 <a class="header-anchor" href="#格式" aria-label="Permalink to &quot;格式&quot;">​</a></h2><blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;#ANIM:&lt;名称&gt;&gt;任意文本&lt;/#ANIM&gt;</span></span></code></pre></div></blockquote><div class="info custom-block"><p class="custom-block-title">示例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;#ANIM:example&gt;文本&lt;/#ANIM&gt;</span></span></code></pre></div></div><h2 id="示例动画文件" tabindex="-1">示例动画文件 <a class="header-anchor" href="#示例动画文件" aria-label="Permalink to &quot;示例动画文件&quot;">​</a></h2><h3 id="animation-example-yml" tabindex="-1">animation_example.yml <a class="header-anchor" href="#animation-example-yml" aria-label="Permalink to &quot;animation_example.yml&quot;">​</a></h3><div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#</span></span>
