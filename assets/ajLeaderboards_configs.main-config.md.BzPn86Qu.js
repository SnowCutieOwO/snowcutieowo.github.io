import{_ as a,c as i,al as n,o as e}from"./chunks/framework.D-_8_VyS.js";const c=JSON.parse('{"title":"主配置文件","description":"","frontmatter":{},"headers":[],"relativePath":"ajLeaderboards/configs.main-config.md","filePath":"ajLeaderboards/configs.main-config.md"}'),l={name:"ajLeaderboards/configs.main-config.md"};function t(p,s,h,k,r,d){return e(),i("div",null,s[0]||(s[0]=[n(`<h1 id="主配置文件" tabindex="-1">主配置文件 <a class="header-anchor" href="#主配置文件" aria-label="Permalink to &quot;主配置文件&quot;">​</a></h1><p>此为默认的主配置文件。所有设置都可在注释中找到详细解读。</p><div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #</span></span>
