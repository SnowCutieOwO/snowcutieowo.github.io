import{_ as n,o as a,c as p,a7 as l}from"./chunks/framework.DSL0mkng.js";const g=JSON.parse('{"title":"消息文本","description":"","frontmatter":{},"headers":[],"relativePath":"LibreLogin/useful-stuff.messages.md","filePath":"LibreLogin/useful-stuff.messages.md"}'),e={name:"LibreLogin/useful-stuff.messages.md"};function t(i,s,o,r,c,u){return a(),p("div",null,s[0]||(s[0]=[l(`<h1 id="消息文本" tabindex="-1">消息文本 <a class="header-anchor" href="#消息文本" aria-label="Permalink to &quot;消息文本&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#  !!文件为 HOCON 格式!!</span></span>
