import{_ as i,c as a,o as n,al as l}from"./chunks/framework.ySGSHPST.js";const o=JSON.parse('{"title":"config.yml 教程","description":"","frontmatter":{},"headers":[],"relativePath":"Codex/config-yml-tutorial.md","filePath":"Codex/config-yml-tutorial.md"}'),p={name:"Codex/config-yml-tutorial.md"};function t(h,s,k,e,r,d){return n(),a("div",null,s[0]||(s[0]=[l(`<h1 id="config-yml-教程" tabindex="-1">config.yml 教程 <a class="header-anchor" href="#config-yml-教程" aria-label="Permalink to &quot;config.yml 教程&quot;">​</a></h1><div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 加入服务器时显示更新提示.</span></span>
