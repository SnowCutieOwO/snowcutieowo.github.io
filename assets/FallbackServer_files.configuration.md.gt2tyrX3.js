import{_ as i,c as a,al as n,o as l}from"./chunks/framework.D-_8_VyS.js";const g=JSON.parse('{"title":"BungeeCord","description":"","frontmatter":{},"headers":[],"relativePath":"FallbackServer/files.configuration.md","filePath":"FallbackServer/files.configuration.md"}'),p={name:"FallbackServer/files.configuration.md"};function k(h,s,t,e,E,r){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="bungeecord" tabindex="-1">BungeeCord <a class="header-anchor" href="#bungeecord" aria-label="Permalink to &quot;BungeeCord&quot;">​</a></h1><div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#  █████▒▄▄▄       ██▓     ██▓     ▄▄▄▄    ▄▄▄       ▄████▄   ██ ▄█▀     ██████ ▓█████  ██▀███   ██▒   █▓▓█████  ██▀███</span></span>
