import{_ as p,C as i,c as h,o as e,b1 as t,G as a}from"./chunks/framework.CC7vnuC4.js";const D=JSON.parse('{"title":"配置","description":"","frontmatter":{"breadcrumbs":[{"title":"Continue Project","link":"/DecentHolograms"},{"title":"配置","link":"/DecentHolograms/general.configuration.config"}]},"headers":[],"relativePath":"DecentHolograms/general.configuration.config.md","filePath":"DecentHolograms/general.configuration.config.md"}'),k={name:"DecentHolograms/general.configuration.config.md"};function r(d,s,g,c,o,y){const n=i("NolebaseGitContributors"),l=i("NolebaseGitChangelog");return e(),h("div",null,[s[0]||(s[0]=t(`<h1 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h1><p>主配置文件</p><div class="info custom-block"><p class="custom-block-title">提示</p><p>主 <code>config.yml</code> 也包含<a href="./general.configuration.features">特性</a>的设置。</p></div><h2 id="config-yml" tabindex="-1">config.yml <a class="header-anchor" href="#config-yml" aria-label="Permalink to &quot;config.yml&quot;">​</a></h2><div class="language-YAML vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">YAML</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># # # # # # # # # # # # # # # # #</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">  &#39;[P]&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;•&#39;</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">  &#39;[|]&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;⎹&#39;</span></span></code></pre></div>`,5)),a(n),a(l)])}const A=p(k,[["render",r]]);export{D as __pageData,A as default};
