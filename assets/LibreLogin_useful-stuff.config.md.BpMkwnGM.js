import{_ as n,c as a,o as p,al as l}from"./chunks/framework.ySGSHPST.js";const m=JSON.parse('{"title":"配置文件","description":"","frontmatter":{},"headers":[],"relativePath":"LibreLogin/useful-stuff.config.md","filePath":"LibreLogin/useful-stuff.config.md"}'),e={name:"LibreLogin/useful-stuff.config.md"};function i(c,s,t,o,r,u){return p(),a("div",null,s[0]||(s[0]=[l(`<h1 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#  !!文件为 HOCON 格式!!</span></span>
